    ...
    <div className="py-12">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {reasons.map((reason, index) => (
            <AnimateOnScroll 
              ...
              duration={0.9}
            >
              <div className="bg-gray-100 p-6 rounded-lg shadow-md border border-gray-200 hover:shadow-lg transition-shadow relative">
                {/* Metal strip at top */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
          ...
          <AnimateOnScroll type="slideRight" duration={0.9}>
            <div className="bg-white p-8 rounded-lg shadow-md border border-gray-200 relative">
              ...
              <ul className="list-none pl-0 mb-6 space-y-3">
                {[
                  ...
                  <AnimateOnScroll key={index} type="slideRight" delay={0.1 * (index + 1)} duration={0.9}>
                    <li className="flex items-center bg-gray-50 p-3 rounded-lg border-l-4 border-primary text-black font-medium">
          ...
          <AnimateOnScroll type="slideLeft" duration={0.9}>
            <div className="bg-gray-100 p-8 rounded-lg shadow-md border border-gray-200 relative">
              ...
              <ol className="space-y-4 relative">
                ...
                {[
                  ...
                  <AnimateOnScroll key={index} type="slideLeft" delay={0.1 * (index + 1)} duration={0.9}>
