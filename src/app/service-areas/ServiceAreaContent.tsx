...
export default function ServiceAreaContent() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 relative">
      ...
      <section className="relative py-12 md:py-20 overflow-hidden min-h-[80vh] flex flex-col">
        {/* Map Title - Moved outside the z-stack */}
        <div className="relative z-30 w-full max-w-7xl px-6 sm:px-8 lg:px-10 mx-auto mb-8 md:mb-12 text-center">
          <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-white mb-3 sm:mb-4">
            Our Service Coverage
          </h2>
          <div className="w-24 h-1.5 bg-amber-500 mx-auto mb-4 rounded-full"></div>
          <p className="text-lg sm:text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            We proudly serve Central Alberta. Check if we service your location using the search above or view our coverage area below.
          </p>
        </div>
