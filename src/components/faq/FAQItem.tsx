  ...
  return (
    <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg shadow-md overflow-hidden">
      <Button
        ...
        className="w-full flex justify-between items-start p-5 sm:p-6 text-left text-gray-800 dark:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-800 hover:text-gray-900 dark:hover:text-white min-h-[max-content]"
        aria-expanded={isOpen}
        variant="ghost"
      >
        <div className="flex-1 mr-4">
          <h3 className="text-base sm:text-lg font-medium break-words whitespace-normal overflow-wrap-normal px-0.5 py-1">{question.question}</h3>
        </div>
      ...
      <AnimatePresence initial={false}>
        {isOpen && (
          ...
          >
            <div className="p-5 sm:p-6 pt-0 border-t border-gray-200 dark:border-gray-700">
              <div 
