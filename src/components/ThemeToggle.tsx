...
export default function ThemeToggle() {
  ...
  // Initialize on mount
  useEffect(() => {
    // Check if dark mode is already active in DOM
  ...
  return (
    <button
      onClick={toggleTheme}
      className={`fixed bottom-6 right-6 z-50 flex items-center justify-center w-12 h-12 rounded-full shadow-lg transition-colors ${
