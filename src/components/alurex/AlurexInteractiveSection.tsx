...
export default function AlurexInteractiveSection() {
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Explore our premium Alurex gutter systems with advanced protection technology.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="relative">
            <div className="aspect-square bg-white rounded-xl shadow-lg overflow-hidden">
              <Image
                ...
                alt={`${currentProduct.name} showcase`}
                fill
          ...
          <div className="space-y-6">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <h4 className={`font-semibold group-hover:text-blue-600 ${
                        activeProduct === product.id ? 'text-blue-600' : 'text-gray-900'
                      }`}>
                        {product.name}
                      </h4>
            ...
            {/* Call to Action */}
            <div className="mt-8 p-6 bg-white border-2 border-blue-600 rounded-lg">
